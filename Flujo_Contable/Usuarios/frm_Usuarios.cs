...
namespace Flujo_Contable
{
    public partial class frm_Usuarios : Form
    {
        ...
        private void CARGA_USUARIOS()
        {
            ...
            {
                MessageBox.Show(ex.Message + "CARGA_USUARIOS()");
            }
        }
        ...
        private void btn_Aceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lbl_Dato.Text == "1")
                {
                    ...
                    {
                        objBitacora.Usuario = lbl_UsuarioLog.Text;
                        objBitacora.Accion = "Actualización";
                        objBitacora.Formulario = "Usuarios";
                        objBitacora.Descripcion = "Usuario Actualizado: " + txt_Login.Text;
                ...
                else
                {
                    ...
                    if (objusuarios.Validacion == "Insertado")
                    {
                        ...
                        objBitacora.Formulario = "Usuarios";
                        objBitacora.Descripcion = "Nuevo Usuario Insertado: " + txt_Login.Text;
                        objBitacora.INSERT_BITACORA();
                        frm_Mensaje objmensaje = new frm_Mensaje();
                ...
                if (lbl_CodigoUsuario.Text != string.Empty)
                {
                    ...
                    switch (dr)
                    {
                        case DialogResult.Yes:
                            ...
                            {
                                objBitacora.Usuario = lbl_UsuarioLog.Text;
                                objBitacora.Accion = "Eliminación";
                                objBitacora.Formulario = "Usuarios";
                                objBitacora.Descripcion = "Usuario Eliminado: " + txt_Login.Text;
                                objBitacora.INSERT_BITACORA();
                                this.LIMPIAR();
                                this.CARGA_USUARIOS();
                                this.CARGA_ROL();
